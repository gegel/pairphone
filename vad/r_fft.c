	...
	{				/* i is stage counter */
		...
		{					/* j is sample counter */
			...
			{				/* k is butterfly top */
				...
				tmp1 = bround(ftmp_real);
				tmp2 = bround(ftmp_imag);
